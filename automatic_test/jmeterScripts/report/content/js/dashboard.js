...
$(document).ready(function () {
    ...
    createTable($("#apdexTable"), {
        ...
        "items": [{"data": [1.0, 500, 1500, "HTTP请求"], "isController": false}]
    }, function (index, item) {
        switch (index) {
            case 0:
                item = item.toFixed(3);
    ...
    createTable($("#statisticsTable"), {
        "supportsControllersDiscrimination": true,
        "overall": {
            "data": ["Total", 100, 0, 0.0, 277.27000000000004, 237, 422, 281.5, 300.0, 311.95, 421.90999999999997, 236.4066193853428, 576.4720005910166, 26.780437352245865],
            "isController": false
        },
        "titles": ["Label", "#Samples", "FAIL", "Error %", "Average", "Min", "Max", "Median", "90th pct", "95th pct", "99th pct", "Transactions/s", "Received", "Sent"],
        "items": [{
            "data": ["HTTP请求", 100, 0, 0.0, 277.27000000000004, 237, 422, 281.5, 300.0, 311.95, 421.90999999999997, 236.4066193853428, 576.4720005910166, 26.780437352245865],
            "isController": false
        }]
    }, function (index, item) {
        switch (index) {
    ...
    createTable($("#top5ErrorsBySamplerTable"), {
        "supportsControllersDiscrimination": false,
        "overall": {
            "data": ["Total", 100, 0, null, null, null, null, null, null, null, null, null, null],
            "isController": false
        },
        "titles": ["Sample", "#Samples", "#Errors", "Error", "#Errors", "Error", "#Errors", "Error", "#Errors", "Error", "#Errors", "Error", "#Errors"],
        "items": [{"data": [], "isController": false}]
    }, function (index, item) {
        return item;
    }, [[0, 0]], 0);
