!function (e, t) {
    ...
    function e() {
        ...
        return new Promise(function (o, r) {
            function a(e, t) {
                for (var n = g(), o = 0; o < n.length; o++) {
                    e += t, e === n.length ? e = 0 : -1 === e && (e = n.length - 1);
                    var i = n[e];
                    if (i.offsetWidth || i.offsetHeight || i.getClientRects().length) return i.focus()
                }
            }
            ...
            function l(n) {
                ...
                if (-1 !== [9, 13, 32, 27].indexOf(i)) {
                    for (var l = o.target || o.srcElement, c = g(), s = -1, u = 0; u < c.length; u++) if (l === c[u]) {
                        s = u;
                        break
                    }
                    9 === i ? (o.shiftKey ? a(s, -1) : a(s, 1), V(o)) : 13 === i || 32 === i ? -1 === s && O(M, o) : 27 === i && e.allowEscapeKey === !0 && (t.closeModal(e.onClose), r("esc"))
                }
            }
            ...
            var d, f = function (n) {
                ...
                var i = o || window.event, a = i.target || i.srcElement, l = y(), c = h(), d = l === a || l.contains(a),
                    p = c === a || c.contains(a), m = w(n, "visible");
                switch (i.type) {
                    case"mouseover":
                    case"mouseup":
                        e.buttonsStyling && (d ? l.style.backgroundColor = s(e.confirmButtonColor, -.1) : p && (c.style.backgroundColor = s(e.cancelButtonColor, -.1)));
                        break;
                    case"mouseout":
                        e.buttonsStyling && (d ? l.style.backgroundColor = e.confirmButtonColor : p && (c.style.backgroundColor = e.cancelButtonColor));
                        break;
                    case"mousedown":
                        e.buttonsStyling && (d ? l.style.backgroundColor = s(e.confirmButtonColor, -.2) : p && (c.style.backgroundColor = s(e.cancelButtonColor, -.2)));
                        break;
                    case"click":
                        if (d && m) if (e.input) {
                            var v = u();
                            e.inputValidator ? (t.disableInput(), e.inputValidator(v, e.extraParams).then(function () {
                                t.enableInput(), f(v)
                            }, function (e) {
                                t.enableInput(), e && t.showValidationError(e)
                            })) : f(v)
                        } else f(!0); else p && m && (t.closeModal(e.onClose), r("cancel"))
                }
            }, q = n.querySelectorAll("button");
            for (d = 0; d < q.length; d++) q[d].onclick = m, q[d].onmouseover = m, q[d].onmouseout = m, q[d].onmousedown = m;
            b().onclick = function () {
            ...
            var M = y(), P = h();
            e.reverseButtons && M.parentNode.insertBefore(P, M), p.previousWindowKeyDown = window.onkeydown, window.onkeydown = l, e.buttonsStyling && (M.style.borderLeftColor = e.confirmButtonColor, M.style.borderRightColor = e.confirmButtonColor), t.showLoading = t.enableLoading = function () {
                k(M, "loading"), k(n, "loading"), M.disabled = !0, P.disabled = !0
            }, t.hideLoading = t.disableLoading = function () {
                x(M, "loading"), x(n, "loading"), M.disabled = !1, P.disabled = !1
            ...
            var T, H = ["input", "select", "radio", "checkbox", "textarea"];
            for (d = 0; d < H.length; d++) {
                var N = i[H[d]];
                for (T = E(n, N); T.attributes.length > 0;) T.removeAttribute(T.attributes[0].name);
                for (var D in e.inputAttributes) T.setAttribute(D, e.inputAttributes[D]);
                T.className = N, e.inputClass && k(T, e.inputClass), A(T)
            }
            var I;
            switch (e.input) {
                case"text":
                ...
                case"password":
                case"file":
                    T = E(n, i.input), T.value = e.inputValue, T.placeholder = e.inputPlaceholder, T.type = e.input, S(T);
                    break;
                case"select":
                    var U = E(n, i.select);
                    if (U.innerHTML = "", e.inputPlaceholder) {
                        var W = document.createElement("option");
                        W.innerHTML = e.inputPlaceholder, W.value = "", W.disabled = !0, W.selected = !0, U.appendChild(W)
                    }
                    I = function (t) {
                        for (var n in t) {
                ...
                case"radio":
                    ...
                    break;
                case"checkbox":
                    var R = E(n, i.checkbox), Z = n.querySelector("#" + i.checkbox);
                    Z.value = 1, Z.checked = Boolean(e.inputValue);
                    var $ = R.getElementsByTagName("span");
                    $.length && R.removeChild($[0]), $ = document.createElement("span"), $.innerHTML = e.inputPlaceholder, R.appendChild($), S(R);
                    break;
                case"textarea":
                    var _ = E(n, i.textarea);
                    _.value = e.inputValue, _.placeholder = e.inputPlaceholder, S(_);
                    break;
                case null:
                    break;
                default:
            ...
            "select" !== e.input && "radio" !== e.input || (e.inputOptions instanceof Promise ? (t.showLoading(), e.inputOptions.then(function (e) {
                t.hideLoading(), I(e)
            })) : "object" == typeof e.inputOptions ? I(e.inputOptions) : console.error("SweetAlert2: Unexpected type of inputOptions! Expected object or Promise, got " + typeof e.inputOptions)), K(), j(e.animation, e.onOpen), a(-1, 1)
        })
    }

    function t() {
        var n = arguments, o = m();
        return null === o && (t.init(), o = m()), w(o, "visible") && N(), e.apply(this, n)
    }
    ...
    var n = "swal2-", o = function (e) {
        ...
        c = function (e, t) {
        ...
        }, d = n + "mediaquery", p = {previousWindowKeyDown: null, previousActiveElement: null}, f = function (e) {
            ...
            return [y(), h()].concat(Array.prototype.slice.call(m().querySelectorAll("button:not([class^=" + n + "]), input:not([type=hidden]), textarea, select")))
        }, w = function (e, t) {
            ...
            for (var n = 0; n < e.childNodes.length; n++) if (w(e.childNodes[n], t)) return e.childNodes[n]
        }, S = function (e) {
            ...
            var e = m();
            window.onkeydown = p.previousWindowKeyDown, p.previousActiveElement && p.previousActiveElement.focus && p.previousActiveElement.focus(), clearTimeout(e.timeout);
            var t = document.getElementsByTagName("head")[0], n = document.getElementById(d);
            n && t.removeChild(n)
        }, D = c({}, a), I = function (e) {
            var t = m();
            for (var n in e) a.hasOwnProperty(n) || "extraParams" === n || console.warn('SweetAlert2: Unknown parameter "' + n + '"');
            t.style.width = e.width + "px", t.style.padding = e.padding + "px", t.style.marginLeft = -e.width / 2 + "px", t.style.background = e.background;
            var o = document.getElementsByTagName("head")[0], l = document.createElement("style");
            l.type = "text/css", l.id = d;
            var c = 5, s = e.width + parseInt(e.width * (c / 100) * 2, 10);
            l.innerHTML = "@media screen and (max-width: " + s + "px) {." + i.modal + " {width: auto !important;left: " + c + "% !important;right: " + c + "% !important;margin-left: 0 !important;}}", o.appendChild(l);
            var u = t.querySelector("h2"), p = t.querySelector("." + i.content), f = y(), v = h(),
                b = t.querySelector("." + i.spacer), g = t.querySelector("." + i.close);
            if (u.innerHTML = e.title.split("\n").join("<br>"), e.text || e.html) {
                if ("object" == typeof e.html) if (p.innerHTML = "", 0 in e.html) for (var w = 0; w in e.html; w++) p.appendChild(e.html[w]); else p.appendChild(e.html); else p.innerHTML = e.html || e.text.split("\n").join("<br>");
                B(p)
            } else L(p);
            if (e.showCloseButton ? B(g) : L(g), t.className = i.modal, e.customClass && k(t, e.customClass), L(t.querySelectorAll("." + i.icon)), e.type) {
                var C = !1;
                for (var E in r) if (e.type === E) {
                    C = !0;
                    break
                }
                if (!C) return console.error("SweetAlert2: Unknown alert type: " + e.type), !1;
                var S = t.querySelector("." + i.icon + "." + r[e.type]);
                switch (B(S), e.type) {
                    case"success":
                        k(S, "animate"), k(S.querySelector(".tip"), "animate-success-tip"), k(S.querySelector(".long"), "animate-success-long");
                        break;
                    case"error":
                        k(S, "animate-error-icon"), k(S.querySelector(".x-mark"), "animate-x-mark");
                        break;
                    case"warning":
                        k(S, "pulse-warning")
                }
            }
            var A = t.querySelector("." + i.image);
            e.imageUrl ? (A.setAttribute("src", e.imageUrl), B(A), e.imageWidth ? A.setAttribute("width", e.imageWidth) : A.removeAttribute("width"), e.imageHeight ? A.setAttribute("height", e.imageHeight) : A.removeAttribute("height"), e.imageClass && k(A, e.imageClass)) : L(A), e.showCancelButton ? v.style.display = "inline-block" : L(v), e.showConfirmButton ? q(f, "display") : L(f), e.showConfirmButton || e.showCancelButton ? B(b) : L(b), f.innerHTML = e.confirmButtonText, v.innerHTML = e.cancelButtonText, e.buttonsStyling && (f.style.backgroundColor = e.confirmButtonColor, v.style.backgroundColor = e.cancelButtonColor), f.className = i.confirm, k(f, e.confirmButtonClass), v.className = i.cancel, k(v, e.cancelButtonClass), e.buttonsStyling ? (k(f, "styled"), k(v, "styled")) : (x(f, "styled"), x(v, "styled"), f.style.backgroundColor = f.style.borderLeftColor = f.style.borderRightColor = "", v.style.backgroundColor = v.style.borderLeftColor = v.style.borderRightColor = ""), e.animation === !0 ? x(t, "no-animation") : k(t, "no-animation")
        }, j = function (e, t) {
            var n = m();
            e ? (P(v(), 10), k(n, "show-swal2"), x(n, "hide-swal2")) : B(v()), B(n), p.previousActiveElement = document.activeElement, k(n, "visible"), null !== t && "function" == typeof t && t.call(this, n)
        }, K = function () {
            var e = m();
            e.style.marginTop = M(e)
        };
    return t.queue = function (e) {
        return new Promise(function (n, o) {
            !function i(r, a) {
                var l = null;
                u(e) ? l = e(r) : r < e.length && (l = e[r]), l ? t(l).then(function () {
                    i(r + 1, a)
                }, function (e) {
                    o(e)
                }) : n()
        ...
        var t = m();
        x(t, "show-swal2"), k(t, "hide-swal2"), x(t, "visible");
        ...
        x(a, "pulse-warning"), N(), H && !w(t, "no-animation") ? t.addEventListener(H, function l() {
            t.removeEventListener(H, l), w(t, "hide-swal2") && (A(t), T(v(), 0))
        }) : (A(t), A(v())), null !== e && "function" == typeof e && e.call(this, t)
        ...
        if (!document.getElementsByClassName(i.container).length) {
            ...
            var n = m(), o = E(n, i.input), r = E(n, i.select), a = n.querySelector("#" + i.checkbox),
                c = E(n, i.textarea);
            o.oninput = function () {
        ...
        D = c({}, a)
    }, t.version = "4.1.0", window.sweetAlert = window.swal = t, function () {
